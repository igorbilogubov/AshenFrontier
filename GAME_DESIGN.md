...
## Принято 18 сентября: чат в мире

По запросу пользователя новое сообщение в чате слышно всем и коротко видно над головой говорящего. История при входе не повторяет звук и пузыри.
...
По запросу пользователя заточка — игровое усиление, не только свечение примерки. Материалы фармятся. Цена золота в 100 раз выше первой таблицы. +1…+3 всегда удаются, +4…+6 с шансом 80%, +7…+9 — 60%. Неудача сбрасывает заточку на +0, камень и золото сгорают. До +6 нужен оселок, дальше закалённый слиток. Стадион ничего не роняет, включая камни. Автоохота всегда подбирает камни. Оселок 2% с обычных; камни в регионе, пока не откроется следующий, плюс 5 уровней задержки. Бонус — 10% основной характеристики слота за уровень, минимум +1 целым числом. Вещь кладут кузнецу на наковальню и точат кнопкой; заранее видно, сколько прибавится.

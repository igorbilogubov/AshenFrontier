...
- 2.5D, настоящие 3D-модели, фиксированный ракурс с зумом. Основные платформы ещё выбираются: браузер/desktop либо преимущественно desktop; мобильная версия рассматривается. Согласована небольшая проба Godot в браузере и на desktop, без решения о полной миграции и без мобильной сборки.
...
Принято 14 сентября 2026: класс выбирается один раз при создании героя; смены класса у костра или позже нет. Правило реализовано на клиенте и сервере, существующие герои сохраняют текущие классы и прогресс без миграции. Предложение для будущих аккаунтов — три бесплатных персонажа. Внутри класса предлагаются минимум две бесплатные сохранённые сборки и переключение в городе вне боя; аккаунты и наборы сборок ещё не реализованы.
...
Общая 3D-опушка и сохранения реализованы. Для закрытия всей основы продукта остаются полноценные аккаунты и усиление хранилища перед экономикой. Следующий игровой шаг — испытание сборок и первый AFK-загон по этапу 2. Доработка моделей пока отложена по запросу пользователя.
...
4. Три бесплатных героя на будущем аккаунте. Неизменяемый выбор класса при создании героя уже принят и реализован; число героев на аккаунте остаётся предложением.

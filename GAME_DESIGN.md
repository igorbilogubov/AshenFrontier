...
По запросу пользователя в игру добавлены готовые бесплатные эффекты (CC0). Музыка не входит. Громкость выключается кнопкой и клавишей M, состояние помнится в браузере.

...
16 сентября пользователь запросил **только предложение** системы билдов и ещё восьми навыков на класс. В [SKILL_BUILDS_PROPOSAL](docs/SKILL_BUILDS_PROPOSAL.md) описаны 12 изучаемых / 4 выбранных навыка, открытие по уровню, отдельные таланты, мобильность и поддержка. Это кандидат на замену прежнего плана четырёх навыков всего, а не принятое правило: код навыков и текущий доступ не менялись.
...
| Живучесть | Здоровье и его регенерация вне боя; выбор между уроном и запасом на ошибку |
...
В уточнённом MVP предлагаются 4 активных навыка на класс плюс обычная атака и зелье; отдельное мастерство и модификаторы навыков в предметах отложены. Для первой проверки достаточно 3 навыков на класс. Все классы способны проходить базовый PvE и фармить самостоятельно; обязательного отдельного аккаунта-баффера нет.
...
Принято 14 сентября 2026: класс выбирается один раз при создании героя; смены класса у костра или позже нет. Правило реализовано на клиенте и сервере, существующие герои сохраняют текущие классы и прогресс без миграции. Принято 16 сентября: до пяти персонажей на Google-аккаунте; одновременно играть может только один, даже из разных окон. Реализовано локально, реальный Google-вход ждёт настройки OAuth. Внутри класса предлагаются минимум две бесплатные сохранённые сборки и переключение в городе вне боя; наборы сборок ещё не реализованы.

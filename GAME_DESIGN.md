...
Реализована первая версия: 5 свободных очков при создании и ещё 5 за уровень. Рядом с распределением показывается конкретное изменение урона, HP/MP, точности, защиты и регенерации. До подтверждения можно отменить правки. Распределение и бесплатный сброс текущей альфы доступны у костра вне боя. Смена класса возвращает вложенные очки. Формулы, миграция и ограничения — [PROGRESSION.md](PROGRESSION.md). Позднейший платный золотом сброс и сохранённые наборы сборок остаются предложениями; платежей за статы нет.

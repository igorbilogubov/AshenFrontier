...
Предложение от 15 сентября о модульном переодевании, цветах качества и первых комплектах: [EQUIPMENT_DESIGN.md](EQUIPMENT_DESIGN.md). Это черновик, не готовая функция и не утверждённый баланс.

...
- 2.5D, настоящие 3D-модели, фиксированный ракурс с зумом. 15 сентября выбраны Three.js + TypeScript и браузер как основная версия, desktop — на том же веб-клиенте. Мобильная версия остаётся возможным последующим направлением. Проба Godot приостановлена. Переход на TypeScript ещё не выполнен; [технологическое направление](TECHNICAL_DIRECTION.md).

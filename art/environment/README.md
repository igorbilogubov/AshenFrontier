...
## Стадиум — 15 сентября 2026

Каменная арена и порталы созданы собственным TypeScript-кодом в `public/game/stadium-environment.ts`, без новых внешних ассетов. Геометрия оград совпадает с общими препятствиями из `public/game/stadium.ts`; три покрытия и обозначения I/II/III различают ровно три загона. Отдельные статические группы позволяют отсекать Стадиум, находясь в лесу. Животные используют прежние GLB проекта. Правила, координаты и проверки: [Стадиум](../../docs/STADIUM.md).

...
import {FOREST_PACK_BASE,LARGE_SPOT_RADIUS,extraIds,packRing} from './pack-size.js';
...
export const AFK_SPOTS:readonly Readonly<AfkSpot>[]=Object.freeze([
  Object.freeze({id:'wolf-den',name:'Волчья ложбина',x:12.7,z:-8.2,radius:LARGE_SPOT_RADIUS,spawnIds:Object.freeze([7,8,9,10,11,12,...extraIds(FOREST_PACK_BASE,0)])}),
  ...
  Object.freeze({id:'eastern-logging',name:'Дальний лесоповал',x:49,z:23,radius:LARGE_SPOT_RADIUS,spawnIds:Object.freeze([25,26,27,28,29,30,...extraIds(FOREST_PACK_BASE,1)])}),
  Object.freeze({id:'bear-grove',name:'Медвежья чаща',x:-27,z:-32,radius:LARGE_SPOT_RADIUS,spawnIds:Object.freeze([83,84,85,86,87,88,...extraIds(FOREST_PACK_BASE,2)])}),
  ...STADIUM_PENS,
  ...SNOW_SPOTS,
  ...WASTELAND_SPOTS,
...
export const FOREST_LARGE_EXTRA_SPAWNS:readonly Readonly<Position & {type:MobType;spotId:AfkSpotId}>[]=Object.freeze([
  // Keep extra wolves east of the (8.5,−8) boulder and off the (20,−10) rock so camp flood-fill can reach them.
  ...[[19.5,-8.2],[17.91,-3.83],[11.66,-2.29],[10.37,-14.59],[15.03,-14.59],[16.56,-12.8]].map(([x,z])=>Object.freeze({type:'wolf' as const,spotId:'wolf-den' as const,x,z})),
  ...packRing(49,23,6.2,0).map(([x,z])=>Object.freeze({type:'boar' as const,spotId:'eastern-logging' as const,x,z})),
  ...packRing(-27,-32,5.9).map(([x,z])=>Object.freeze({type:'bear' as const,spotId:'bear-grove' as const,x,z})),
]);

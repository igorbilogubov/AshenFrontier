...
export const GEAR_CHANCE:Readonly<Record<MobType,number>>=Object.freeze({wolf:.10,boar:.10,bear:.10,alpha:.40,lynx:.10,yak:.10,'frost-spider':.10,'ice-golem':.10,'ash-jackal':.10,scorpion:.10,'monitor-lizard':.10,scarab:.10});

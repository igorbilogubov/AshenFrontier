...
function initialPlayer():ClientPlayer {
  return {...characterStats({classId:'warrior',level:1}),schemaVersion:3,id:'',name:'Странник',classId:'warrior',level:1,
    ...
    coins:0,gold:0,xp:0,kills:0,attack:null,dead:0,hurt:0,items:[],pendingItems:[],equipment:{},mana:40,
    potionCooldown:0,specialCooldown:0,combatUntil:0,attackSerial:0,running:false,questKills:0,boss:false,questClaimed:false,ack:0};
}

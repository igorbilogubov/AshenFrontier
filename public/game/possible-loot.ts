...
import {BOSS_GEAR_CHANCE,BOSS_RARITY_CHANCES,GEAR_CHANCE,ELITE_GEAR_CHANCE,ELITE_RARE_CHANCE} from './loot-rules.js';
...
export function possibleLoot(type:MobType,eliteId?:string,bossId?:DungeonId):PossibleLoot{
  ...
  for(const id of ['weapon','armor','accessory'] as const){
    ...
    for(const rarity of rarities){
      ...
      const chance=bossId?BOSS_RARITY_CHANCES[rarity]:eliteId?(rarity===2?ELITE_RARE_CHANCE:ELITE_GEAR_CHANCE-ELITE_RARE_CHANCE):undefined;

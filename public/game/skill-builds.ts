...
const nodes:Record<string,Node[]>={
 ...
 ranger:[['Сильный яд','Урон яда +5% за ранг.','dotDamage',.05],['Лёгкие шаги','Скорость передвижения +2% за ранг.','movement',.02],['Экономия','Одиночные навыки: расход MP −3% за ранг.','singleEconomy',.03],['Живучесть','Регенерация HP +5% за ранг. В бою действует с третью скорости.','hpRegen',.05],['Ускользание','Входящий урон −2% за ранг.','reduction',.02]],

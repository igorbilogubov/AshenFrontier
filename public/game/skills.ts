...
export interface SkillDefinition {
  id: SkillId; classId: ClassId; slot: 'Q' | 'E' | 'Z' | 'X'; name: string; description: string;
...
export const SKILLS: Readonly<Record<SkillId, Readonly<SkillDefinition>>> = Object.freeze({
  ...
  'warrior-thrust': {id:'warrior-thrust',classId:'warrior',slot:'Z',name:'Выпад',description:'Сильный узкий выпад по одной цели перед собой.',manaCost:14,cooldown:6,durationScale:1.15,hitFraction:.57,damageScale:2.15,range:3,halfAngle:.33,maxTargets:1},
  'warrior-shockwave': {id:'warrior-shockwave',classId:'warrior',slot:'X',name:'Ударная волна',description:'Узкая волна земли впереди, до 4 целей.',manaCost:22,cooldown:9,durationScale:1.4,hitFraction:.67,damageScale:1.5,range:4.2,halfAngle:.36,maxTargets:4},
  'archer-frost-shot': {id:'archer-frost-shot',classId:'archer',slot:'Z',name:'Морозная стрела',description:'Одна дальняя стрела замедляет цель на 2,5 секунды.',manaCost:18,cooldown:6,durationScale:1.2,hitFraction:.52,damageScale:1.55,range:7.2,maxTargets:1,projectileSpeed:14},
  'archer-rain': {id:'archer-rain',classId:'archer',slot:'X',name:'Дождь стрел',description:'Через 0,45 с поражает до 4 целей в области впереди.',manaCost:26,cooldown:10,durationScale:1.45,hitFraction:.61,damageScale:1.18,range:5.3,radius:1.75,maxTargets:4},
  'mage-lightning': {id:'mage-lightning',classId:'mage',slot:'Z',name:'Цепная молния',description:'Ток перескакивает между 3 близкими целями с падением урона.',manaCost:30,cooldown:7,durationScale:1.28,hitFraction:.55,damageScale:1.55,range:5.2,radius:1.9,maxTargets:3},
  'mage-meteor': {id:'mage-meteor',classId:'mage',slot:'X',name:'Метеор',description:'Через 0,7 с падает в область впереди, до 5 целей.',manaCost:38,cooldown:12,durationScale:1.6,hitFraction:.65,damageScale:1.72,range:5.1,radius:1.9,maxTargets:5},
});

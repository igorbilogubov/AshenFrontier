...
export interface Portal extends Position {readonly id:'camp-stadium'|'stadium-camp'|'forest-snow'|'snow-forest';readonly minLevel?:number;readonly name:string;readonly range:number;readonly destination:Readonly<Position>;readonly destinationName:string}
...
export const portalById=(id:unknown)=>typeof id==='string'?[...PORTALS,...SNOW_PASSAGES].find(portal=>portal.id===id):undefined;

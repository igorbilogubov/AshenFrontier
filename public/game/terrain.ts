...
import {AFK_SPOTS,AFK_SPAWNS,BEAR_AFK_SPAWNS,FOREST_LARGE_EXTRA_SPAWNS,forestTrailDistance,withinSpot} from './afk.js';
...
const protectedSpawns=[...spawns,...AFK_SPAWNS,...ROAMING_SPAWNS,...EXTRA_ROAMING_SPAWNS,...BEAR_AFK_SPAWNS,...FOREST_LARGE_EXTRA_SPAWNS];

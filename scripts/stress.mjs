...
const child=spawn(process.execPath,['server.mjs'],{cwd:root,stdio:['inherit','pipe','inherit'],env:{...process.env,PORT:process.env.STRESS_PORT||'4742',GAME_HOST:'127.0.0.1',GAME_PREVIEW_ALIAS:'0',GAME_DATA_DIR:dir,GAME_ALLOWED_ORIGINS:'',GAME_STRESS:'1',GAME_STRESS_REPORTS:reports,NODE_ENV:'development'}});

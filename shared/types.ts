...
export interface PersistentHero extends Point {
  ...
  specialCooldown: number; dead: number; combatUntil: number; attack: HeroAttack | null; attackSerial: number;
...
export interface PublicMob extends Point {
  ...
  yaw: number; targetYaw: number; age: number; gait: number; speed: number; flash: number; target: string | null;
}

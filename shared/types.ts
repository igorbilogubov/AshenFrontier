...
export type SkillId = 'warrior-cleave' | 'warrior-whirlwind' | 'archer-piercing' | 'archer-volley' | 'mage-fireball' | 'mage-frost' | 'warrior-thrust' | 'warrior-shockwave' | 'archer-frost-shot' | 'archer-rain' | 'mage-lightning' | 'mage-meteor' | 'warrior-heavy' | 'warrior-bleed' | 'warrior-charge' | 'warrior-leap' | 'warrior-guard' | 'warrior-berserk' | 'warrior-shout' | 'warrior-banner' | 'archer-aimed' | 'archer-poison' | 'archer-retreat' | 'archer-roll' | 'archer-trap' | 'archer-focus' | 'archer-wind' | 'archer-smoke' | 'mage-ice-lance' | 'mage-beam' | 'mage-teleport' | 'mage-ice-step' | 'mage-mana-shield' | 'mage-seals' | 'mage-ward' | 'mage-mana-source';
export type SkillLoadout = [SkillId|null,SkillId|null,SkillId|null,SkillId|null];

...
export function equipLegacySkills(hero){hero.level=Math.max(hero.level,22);hero.skillBuild={slots:[...original[hero.classId],null,null],talents:{}};hero.afkPreferences={...hero.afkPreferences,attackSkill:original[hero.classId][0],buffSkills:[]};return hero;}

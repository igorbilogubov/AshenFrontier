...
export function equipLegacySkills(hero){hero.level=Math.max(hero.level,22);hero.skillBuild={slots:[...original[hero.classId]],talents:{}};hero.afkPreferences.skillOrder=original[hero.classId].slice(0,2);return hero;}
